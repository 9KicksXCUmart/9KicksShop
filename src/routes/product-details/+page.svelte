<script>
	...
	const reviews = Array(10).fill({
		...
		comment: "I recently got my hands on the Nike Dunk Low \"Panda\", and it's safe to say, I'm in love! Right out of the box!"
	});
</script>
...
<div class="flex flex-col items-center w-full h-fit">
	<div class="flex flex-col items-center w-[1920px] h-fit">
		...
		<div class="flex flex-row items-center w-full justify-between px-[17%]">
			...
			<DisChart ratingDistri={ratingDistri} />
		</div>
		...
		<div class="flex w-full h-[600px] px-[17%] mb-50px">
			<div class="flex flex-col justify-center items-start w-full max-h-[600px] space-y-[10px] overflow-auto">
